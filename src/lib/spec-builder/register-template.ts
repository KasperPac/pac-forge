...
const INSTRUCTIONS: string[][] = [
  ...
  [""],
  ["Fill in the Register sheet. One row per signal. The ISA-88 physical hierarchy"],
  ["is extracted deterministically from the columns below — no AI is used for structure."],
  [""],
  ...
  ["control_module", "Yes", "Groups signals onto one device (ISA-88 Control Module), e.g. M1, VSD1. Same device = same value."],
  ["equipment_module", "Yes", "ISA-88 Equipment Module the control module belongs to, e.g. Conveyor CV01, Carriage."],
  ["unit", "No", "Leave BLANK for a single-unit job. Fill ONLY when groups of equipment"],
  ["", "", "modules run under independent operating sequences (e.g. Infeed vs Outfeed)."],
  ...
  [""],
  ["Hierarchy (ISA-88 §4.4): Process Cell > Unit > Equipment Module > Control Module."],
  ["Default is ONE unit. Only add units for independent operating sequences."],
];
