...
import { FolderOpen, Bot, Terminal, BookOpen, GraduationCap, Layers, SlidersHorizontal, FileText, Library, LogOut, User, Sun, Moon, Monitor, ChevronRight, PanelLeftClose, PanelLeftOpen, Wand2, BookPlus, Building2, Cpu, FlaskConical, LayoutDashboard, ClipboardList, SearchCode, Receipt, ScrollText, FileDiff } from "lucide-react";
