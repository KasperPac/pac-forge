...
| G6-7 | "Promote to library" — one-click promotion of a generated EM/CM block set into `fb_templates`, interface contract + PackML states auto-derived from the codegen IR (pin roles, safe state) so the coverage gate passes with zero hand-authoring | 🔴 | P1 | M | G6-2,G6-3 | Added 2026-07-22 from G9 ladder planning (Kasper: reuse Level 1 blocks in Levels 2–4). Answers the open question "should a commissioned project seed an EM/CM library?" — makes the validation ladder compound; promoted blocks are regen-immune (feeds G9-3) |
